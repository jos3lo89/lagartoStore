	...
	?>
		...
		<div class="columns">
			<div class="column is-two-fifths">
				...
				<?php if (is_file("./app/vista/productos/" . $datos['producto_foto'])) { ?>
					<figure class="image mb-6">
						<img class="is-photo" src="<?php echo APP_URL; ?>app/vista/productos/<?php echo $datos['producto_foto']; ?>">
					</figure>
				...
				<?php } else { ?>
					<figure class="image mb-6">
						<img class="is-photo" src="<?php echo APP_URL; ?>app/vista/productos/default.png">
					</figure>
				<?php } ?>
			</div>
