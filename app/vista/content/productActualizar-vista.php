...
<div class="container p-6">
	...
	include "./app/vista/inc/btn_back.php";
	...
	?>
		...
		<div class="columns is-flex is-justify-content-center">
			<figure class="full-width mb-3" style="max-width: 170px;">
				<?php
				if (is_file("./app/vista/productos/" . $datos['producto_foto'])) {
					echo '<img class="img-responsive" src="' . APP_URL . 'app/vista/productos/' . $datos['producto_foto'] . '">';
				} else {
					echo '<img class="img-responsive" src="' . APP_URL . 'app/vista/productos/default.png">';
				}
				?>
			</figure>
		</div>
		...
		<form class="FormularioAjax" action="<?php echo APP_URL; ?>app/ajax/productoAjax.php" method="POST" autocomplete="off">
			...
			<div class="columns">
				...
				<div class="column">
					<div class="control">
						<label>Color</label>
						<input class="input" type="text" name="producto_color" value="<?php echo $datos['producto_color']; ?>" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,#\- ]{1,30}" maxlength="30">
					</div>
				</div>
				<div class="column">
					<div class="control">
	...
	<?php
		...
		include "./app/vista/inc/error_alert.php";
	}
	?>
</div>