...
<div class="container px-6">
    ...
    ?>
        <div class="">
            ...
            <div class="mx-6">
                ...
                <form class="pb-6" id="sale-barcode-form" autocomplete="off">
                    <div class="columns">
            ...
            <div class="column is-half is-offset-one-quarter pb-6">
    ...
    <?php } else { ?>
        <article class="message is-warning">
            ...
            <div class="message-body has-text-centered"><i class="fas fa-exclamation-triangle fa-2x"></i><br>No hemos podio seleccionar algunos datos sobre la empresa, por favor <a href="<?php echo APP_URL; ?>empresaDatos/">verifique aquí los datos de la empresa</div>
        </article>
    <?php } ?>
</div>
