...
class usuarioControlador extends principalModelo
{
			...
			foreach ($datos as $rows) {
				$tabla .= '
						<tr class="has-text-centered" >
							...
							<td>
			                    <a href="' . APP_URL . 'usuarioFoto/' . $rows['usuario_id'] . '/" class="button is-info is-rounded is-small">
			                    	<i class="fas fa-camera fa-fw"></i>
			                    </a>
			                </td>
			                <td>
			                    <a href="' . APP_URL . 'usuarioActualizar/' . $rows['usuario_id'] . '/" class="button is-success is-rounded is-small">
	...
	public function eliminarUsuarioControlador()
	{
		...
		if ($eliminarUsuario->rowCount() == 1) {
			...
			if (is_file("../vista/fotos/" . $datos['usuario_foto'])) {
				chmod("../vista/fotos/" . $datos['usuario_foto'], 0777);
				unlink("../vista/fotos/" . $datos['usuario_foto']);
			}
