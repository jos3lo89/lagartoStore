			...
			foreach ($datos as $rows) {
				...
				$tabla .= '</p>
		                ...
		                <div class="caja_datos">
		                    <div class="content">
		                        <div class="box_datitios">
									<div class="contador_caja"> <p>' . $contador . '</p> </div>

		                            <div class="cajita_datos"> <p class="has-text-link texto_dato" >Nombre: <span class="has-text-black" >' . $rows['producto_nombre'] . '</span> </p>  </div>

		                            <div class="cajita_datos"> <p class="has-text-link texto_dato" >Codigo: <span class="has-text-black" >' . $rows['producto_codigo'] . '</span> </p> </div>

		                            <div class="cajita_datos"> <p class="has-text-link texto_dato" >Precio: <span class="has-text-black" > S/ ' . $rows['producto_precio_venta'] . '</span> </p>  </div>

		                            <div class="cajita_datos"> <p class="has-text-link texto_dato" >Stock:  <span class="has-text-black" >' . $rows['producto_stock_total'] . '</span> </p> </div>

		                            <div class="cajita_datos"> <p class="has-text-link texto_dato" >Categ:  <span class="has-text-black" >' . $rows['categoria_nombre'] . '</span> </p> </div>
