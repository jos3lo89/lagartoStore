...
class ventaControlador extends principalModelo
{
	...
	public function buscarCodigoVentaControlador()
	{
		...
		$datos_productos = $this->ejecutarConsulta("SELECT * FROM producto WHERE (producto_nombre LIKE '%$producto%' OR producto_marca LIKE '%$producto%' OR producto_color LIKE '%$producto%') ORDER BY producto_nombre ASC");
				...
				$tabla .= '
						<tr class="has-text-centered" >
			                ...
			                <td>
			                    ...
			                    <a href="' . APP_URL . 'ventaDetalle/' . $rows['venta_codigo'] . '/" class="button is-link is-rounded is-small" title="Informacion de venta Nro. ' . $rows['venta_id'] . '" >
