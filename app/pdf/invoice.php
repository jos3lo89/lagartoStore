...
if ($datos_venta->rowCount() == 1) {
	...
	$pdf->AddPage();
	$pdf->Image(APP_URL . 'app/vista/img/logo.png', 165, 12, 35, 35, 'PNG');
	...
	foreach ($venta_detalle as $detalle) {
		$pdf->Cell(100, 7, utf8_decode($ins_venta->limitarCadena($detalle['venta_detalle_descripcion'], 80, "...")), 'L', 0, 'C');
...
?>
	...
	<head>
		...
		<?php include '../vista/inc/head.php'; ?>
	</head>
	...
	<body>
		...
		<?php include '../vista/inc/script.php'; ?>
	</body>
